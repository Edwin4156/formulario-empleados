...
public class conexion_db {
    ...
    private final String db = "db_personas2";
    private final String urlconexion = String.format("jdbc:mysql://localhost:3306/db_personas2");
    private final String user = "root";
    private final String password = "Edw43520154*";
